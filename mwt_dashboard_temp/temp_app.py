...
if page == pages[0]:
    ...
    # Insert download graph button
    st.subheader("DEBUG: tap_tstat_allele Preview")
    st.write("Columns in tap_tstat_allele:", tap_tstat_allele.columns.tolist())
    st.write("Shape:", tap_tstat_allele.shape)
    st.write(tap_tstat_allele.head())
    # Create a heatmap
