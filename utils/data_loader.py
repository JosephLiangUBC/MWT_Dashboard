...
def fetch_data():
    ...
    with psycopg.connect(
        ...
        listofgenecolumns = ['Gene', 'Screen', 'Morphwidth', 'Midline', 'Area', 'Speed',
                            ...
                            'Initial 1s Speed',
                            'Initial PSA Speed', 'Initial PSA Bias', 
                            ...
                            'Final Response Speed', 'Final 1s Speed', 'Final PSA Speed', 'Final PSA Bias',
                            # 'Final PSA Angular Speed', 
                            'Final PSA Aspect Ratio', 'Final PSA Kink',
                            'Final PSA Curve', 'Final PSA Crab',
                            'Peak PSA Speed', 'Peak PSA Bias', 
                            # 'Peak PSA Angular Speed',
                            'Peak PSA Aspect Ratio', 'Peak PSA Kink', 'Peak PSA Curve', 
                            'Peak PSA Crab',
                            ...
                            'Average PSA Speed', 'Average PSA Bias', 
                            ...
                            'Spontaneous Recovery of Response Speed', 'Spontaneous Recovery of 1s Speed',
                            'Spontaneous Recovery of PSA Speed', 'Spontaneous Recovery of PSA Bias',
                            ...
                            'Memory Retention of Response Speed', 'Memory Retention of 1s Speed',
                            'Memory Retention of PSA Speed', 'Memory Retention of PSA Bias',
